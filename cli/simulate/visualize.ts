...
export const handleSimulateVisualize = async (
  file: string,
  options: {
    output?: string
  ...
  try {
    ...
    console.log(
      kleur.cyan("Generating SPICE netlist with simulation parameters..."),
    )
    ...
    console.log(
      kleur.cyan("Embedding simulation data into circuit visualization..."),
    )
    const {
    ...
    console.log(kleur.gray(`   Experiment ID: ${simulation_experiment_id}`))
    console.log(
      kleur.gray(
