...
export default () => {
  ...
  return (
    <board width="22mm" height="30mm" manualEdits={manualEdits}>
      <USBC GND="net.GND" pcbY={-10} VBUS1="net.VBUS" />
      <Led neg="net.GND" pcbY={12} />
      <Button pcbY={0} pin2=".R1 > .pos" pin3="net.VBUS" />
      <Button pcbY={-2} pin2=".R1 > .pos" pin3="net.VBUS" />
      <Button pcbY={5} pin2=".R1 > .pos" pin3="net.VBUS" />
      <Button pcbY={3} pin2=".R1 > .pos" pin3="net.VBUS" />
