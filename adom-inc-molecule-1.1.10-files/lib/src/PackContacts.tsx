...
export const PackContacts: React.FC<PackContactsProps> = ({
  ...
  const calculateElementPositions = (
    ...
    if (
      ...
      if (marginName === "topLeftCorner_Diagonal") {
        ...
        console.log(
          "topLeftCorner_Diagonal: offsetX: ",
          offsetX,
          ", offsetY: ",
          offsetY,
        )
        ...
        offsetY = -(wingTop - contactBoundingBoxSize) / 2
        console.log(
          "topRightCorner_Diagonal: offsetX: ",
          offsetX,
          ", offsetY: ",
          offsetY,
        )
        ...
        console.log(
          "bottomLeftCorner_Diagonal: offsetX: ",
          offsetX,
          ", offsetY: ",
          offsetY,
        )
        ...
        offsetY = (wingBottom - contactBoundingBoxSize) / 2
        console.log(
          "bottomRightCorner_Diagonal: offsetX: ",
          offsetX,
          ", offsetY: ",
          offsetY,
        )
  ...
  useEffect(() => {
    if (moleculesInfoRef.current.length > 0) {
      console.log("PackContacts: Detected molecules", moleculesInfoRef.current)
